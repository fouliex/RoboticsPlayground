...
q1, q2, q3, q4 = symbols('q1:5')  # slice doesn't include the end value
...
# Rotation matrices for  elementary rotation  on the X axes
R_x = Matrix([[1, 0, 0], [0, cos(q1), -sin(q1)], [0, sin(q1), cos(q1)]])

# Rotation matrices for elementary rotation on the Y axes
R_y = Matrix([[cos(q2), 0, sin(q2)], [0, 1, 0], [-sin(q2), 0, cos(q2)]])

# Rotation matrices for elementary rotation on the Z axes
